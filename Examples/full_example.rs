...
fn test_dropdown_on_value_change(widget_path: String, view_tree: &mut common::ViewTree,
                                 state_tree: &mut common::StateTree,
                                 widget_tree: &common::WidgetTree) {
...
fn test_text_input_on_value_change(widget_path: String, view_tree: &mut common::ViewTree,
                                 state_tree: &mut common::StateTree,
                                 widget_tree: &common::WidgetTree) {
...
fn test_text_input_on_keyboard_enter(widget_path: String, view_tree: &mut common::ViewTree,
                                   state_tree: &mut common::StateTree,
                                   widget_tree: &common::WidgetTree) {
    ...
    // parameter as a key. The state contains the current value. Then we cast the generic widget
    // state as a TextInputState, so we can access all its fields.
    let text_input_state = state_tree
        .get_mut(&widget_path)
        .unwrap()
        .as_text_input_mut();
