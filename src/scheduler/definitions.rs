...
pub type OptionalMouseCallbackFunction = Box<dyn FnMut(Context, Option<Coordinates>) -> bool + Send>;
...
impl<'a, 'b> Context<'a, 'b> {
    ...
    pub fn new(widget_path: String, state_tree: &'a mut StateTree,
        ...
        -> Self { Context { widget_path, state_tree, scheduler } }
}
...
impl ThreadedContext {
    ...
    pub fn new(widget_path: String, state_tree: StateTree, scheduler: SchedulerFrontend)
               -> Self { ThreadedContext { widget_path, state_tree, scheduler } }
}
