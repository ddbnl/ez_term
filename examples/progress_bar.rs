...
fn main() {
    ...
    let callback_config = CallbackConfig::from_on_press(Box::new(manual_progress_callback));
    ...
    let callback_config = CallbackConfig::from_on_press(Box::new(task_progress_callback));
    ...
    let thread_progress_callback = |context: Context| {
        ...
        context
            .scheduler
            .schedule_threaded(Box::new(progress_thread), Some(Box::new(on_finish)));
        false
    };
    let callback_config = CallbackConfig::from_on_press(Box::new(thread_progress_callback));
